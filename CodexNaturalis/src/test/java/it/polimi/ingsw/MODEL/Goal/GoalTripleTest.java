...
class GoalTripleTest {
    ...
    Goal goalM = new Goal(triplarisorsa, 4, AnglesEnum.MUSHROOMS, "aa");
    Goal goalI = new Goal(triplarisorsa, 4, AnglesEnum.INSECTS, "aa");
    Goal goalA = new Goal(triplarisorsa, 4, AnglesEnum.ANIMAL, "aa");
    Goal goalP = new Goal(triplarisorsa, 4, AnglesEnum.PLANT, "aa");
    @Test
    void totalPoints() {
