...
class GoalStrategyTest {
    ...
    Goal goalA = new Goal(FiguraLA, 4, AnglesEnum.ANIMAL, "aa");
    Goal goalM = new Goal(FiguraLM, 4, AnglesEnum.MUSHROOMS, "aa");
    Goal goalP = new Goal(FiguraLP, 4, AnglesEnum.PLANT, "aa");
    Goal goalI = new Goal(FiguraLI, 4, AnglesEnum.INSECTS, "aa");
    ...
    Goal goalDiagonaleA = new Goal(diagonaleA, 4, AnglesEnum.ANIMAL, "aa");
    Goal goalDiagonaleM = new Goal(diagonaleM, 4, AnglesEnum.MUSHROOMS, "aa");
    Goal goalDiagonaleP = new Goal(diagonaleP, 4, AnglesEnum.PLANT, "aa");
    Goal goalDiagonaleI = new Goal(diagonaleI, 4, AnglesEnum.INSECTS, "aa");
