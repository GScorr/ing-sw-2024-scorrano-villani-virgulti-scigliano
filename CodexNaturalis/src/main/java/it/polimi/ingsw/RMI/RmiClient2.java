...
public class RmiClient2 extends UnicastRemoteObject implements VirtualView {
    final VirtualServer server;
    private  String token;

    protected RmiClient2(VirtualServer server) throws RemoteException {
        this.server = server;
    }
