...
public class Constants {
    ...
    public final static String IPV4 = "192.168.32.78";
           // "192.168.162.78";
    ...
    public final static String ANSI_BLUE = "\u001B[36m";
    ...
    // Background colors (replace "color" with the desired color code)
    public final static String ANSI_BLACK_BACKGROUND = "\u001B[40m";
    public final static String ANSI_LIGHT_GRAY_BACKGROUND = "\u001B[47m";  // Light Grey
    public final static String ANSI_DARK_GRAY_BACKGROUND = "\u001B[40m";  // Dark Grey
